  ...
  return (
    <section className="relative py-16 px-4 sm:px-6 lg:px-8 bg-white dark:bg-gray-900">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-primary rounded-2xl p-4 sm:p-12 shadow-xl">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="flex items-center justify-center gap-3 mb-8">
              ...
              <h3 className="text-2xl sm:text-3xl font-bold text-white">Repay with USSD</h3>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
              ...
              <div className="bg-white/10 backdrop-blur-sm rounded-xl p-8 border border-white/20 text-center hover:bg-white/15 transition-all duration-300">
                <div className="text-4xl sm:text-6xl font-black text-white mb-3">
                  *928*222#
                </div>
            ...
            <div className="grid grid-cols-3 gap-2 sm:gap-4 text-center">
              {paymentSteps.map((step) => (
                <div key={step.number} className="bg-white/5 rounded-lg p-4">
                  ...
                  <p className="text-xs sm:text-sm text-white/90 font-medium">{step.title}</p>
                </div>
              ))}
            </div>
          </div>
